...
from jukebox.utils.audio_utils import (audio_postprocess, multispectral_loss,
                                       spectral_convergence, spectral_loss)
...
class VQVAE(nn.Module):
    ...
    def sample(self, n_samples):
        zs = [
            t.randint(0, self.l_bins, size=(n_samples, *z_shape), device=self.device)
